...
from chanlib.compat import ChanSignals
from chanlib.chanlun.pyChanlun import ChanBi, ChanDuan, ChanObject
...
def check_chan_xt_five_bi(kline, bi_list: List[ChanObject]):
    ...
    if direction == -1:
        ...
        if max_high == bi_1.high and min_low == bi_5.low and bi_4.high < bi_2.low \
            ...
            return ChanSignals.LQ0.value  # "底背驰" 五笔类趋势

        # 上颈线突破
        if (min_low == bi_1.low and bi_5.high > min(bi_1.high, bi_2.high) > bi_5.low > bi_1.low and bi_1.high > bi_3.low) \
                or (min_low == bi_3.low and bi_5.high > bi_3.high > bi_5.low > bi_3.low and bi_1.high > bi_3.low):
    ...
    # 上涨线段，寻找顶背驰
        ...
        if min_low == bi_1.low and max_high == bi_5.high \
            ...
            return ChanSignals.SQ0.value  # k3='基础形态', v1='顶背驰', v2='五笔类趋势')

        # 下颈线突破
        if (max_high == bi_1.high and bi_5.low < max(bi_1.low, bi_2.low) < bi_5.high < max_high and bi_1.low < bi_3.high) \
                or (max_high == bi_3.high and bi_5.low < bi_3.low < bi_5.high < max_high and bi_1.low < bi_3.high):
    ...
    if bi_7.direction == -1:
        if bi_1.high == max_high and bi_7.low == min_low:
            ...
            if min(bi_2.high, bi_4.high) > max(bi_2.low, bi_4.low) > bi_6.high \
                ...
                v = ChanSignals.LQ0.value  # k3='基础形态', v1='底背驰', v2='七笔aAbcd式')
            ...
            if bi_2.low > bi_4.high and bi_4.low > bi_6.high \
                ...
                v = ChanSignals.LQ0.value  # k3='基础形态', v1='底背驰', v2='七笔类趋势'
        ...
        if bi_1.low == min_low and bi_7.high == max_high:
            ...
            if bi_6.low > min(bi_2.high, bi_4.high) > max(bi_2.low, bi_4.low) \
                    and bi_7.height < bi_5.height and bi_7.atan <= bi_5.atan:
                v = ChanSignals.SQ0.value  # k3='基础形态', v1='顶背驰', v2='七笔aAbcd式'
            ...
            if bi_2.high < bi_4.low and bi_4.high < bi_6.low \
                    and bi_7.height < max(bi_5.height, bi_3.height, bi_1.height) \
                    and bi_7.atan < max(bi_5.atan, bi_3.atan, bi_1.atan):
                v = ChanSignals.SQ0.value  # k3='基础形态', v1='顶背驰', v2='七笔类趋势'
    ...
    if direction == -1:
        ...
        if bi_8.height < bi_2.height and max_high == bi_9.high \
            ...
            if bi_3.height > bi_5.height > bi_7.height \
                ...
                atan = (bi_3.high - bi_7.high) / (bi_3.bars + bi_4.bars + bi_5.bars + bi_6.bars - 3)
